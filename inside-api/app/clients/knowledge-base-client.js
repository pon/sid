...
class KnowledgeBaseClient {
  ...
  verifyIncome(incomeId, verifiedIncome) {
    return this._post(`/incomes/${incomeId}/verify`, {
      body: {
  ...
  unverifyIncome(incomeId, verifiedIncome) {
    return this._post(`/incomes/${incomeId}/unverify`, {json: true}).then(res => res.body)
  }
  ...
  getApplications(query) {
    return this._get(
      `/applications`,
      query ? {json: true, qs: query} : {json: true}
    )
    .then(res => res.body)
  }
